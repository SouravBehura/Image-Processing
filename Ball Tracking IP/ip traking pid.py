...
while(True):
    ...
    mid_w = int(width/2)
    cX=mid_w
    #print(blur_img[mid_h][mid_w][0],blur_img[mid_h][mid_w][1],blur_img[mid_h][mid_w][2])
    cv2.line(img,(0,mid_h),(width,mid_h),(255,0,0),3)
    cv2.line(img,(mid_w,(mid_h+20)),(mid_w,(mid_h-20)),(255,0,0),3)
    #cv2.line(img,(mid_w,(mid_h+20)),(mid_w,(mid_h-20)),(0,255,0),3)

    #ret,thresh = cv2.threshold(hsv_img,255,255,255)
    ...
    #cv2.imshow('Binary Image',hsv_img)
